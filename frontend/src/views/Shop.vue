  ...
  <div class="shop-container">
    <div class="shop-toolbar">
      <div class="toolbar-left">
        <el-input v-model="searchForm.keyword" placeholder="搜索商品..." :prefix-icon="Search" clearable @keyup.enter="handleSearch" class="toolbar-search" />
        <el-select v-model="searchForm.categoryId" placeholder="全部分类" clearable class="toolbar-select">
          <el-option v-for="cat in categories" :key="cat.id" :label="cat.name" :value="cat.id" />
        </el-select>
        <el-select v-model="searchForm.orderBy" placeholder="默认排序" class="toolbar-select">
      ...
      <div class="toolbar-right">
        <span class="product-count" v-if="total > 0">共 <em>{{ total }}</em> 件商品</span>
