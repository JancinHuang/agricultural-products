...
('admin', '$2a$10$QkKU3ig.GuzpJAtcPF8.Su6l7M4ngwaJFqPX2M1znypkDKRCyIQie', '系统管理员', '13800138000', 'admin@example.com', NULL, 1, 1),
('user1', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '张三', '13800138001', 'zhangsan@example.com', NULL, 0, 1),
('user2', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '李四', '13800138002', 'lisi@example.com', NULL, 0, 1),
('user3', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '王五', '13800138003', 'wangwu@example.com', NULL, 0, 1),
('user4', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '赵六', '13800138004', 'zhaoliu@example.com', NULL, 0, 1),
('user5', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '孙七', '13800138005', 'sunqi@example.com', NULL, 0, 1),
('user6', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '周八', '13800138006', 'zhouba@example.com', NULL, 0, 1),
('user7', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '吴九', '13800138007', 'wujiu@example.com', NULL, 0, 1),
('user8', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '郑十', '13800138008', 'zhengshi@example.com', NULL, 0, 1),
('user9', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '钱十一', '13800138009', 'qianshiyi@example.com', NULL, 0, 1),
('user10', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '陈十二', '13800138010', 'chenshier@example.com', NULL, 0, 1),
('user11', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '林十三', '13800138011', 'linshisan@example.com', NULL, 0, 1),
('user12', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '黄十四', '13800138012', 'huangshisi@example.com', NULL, 0, 1),
('user13', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '杨十五', '13800138013', 'yangshiwu@example.com', NULL, 0, 1),
('user14', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '刘十六', '13800138014', 'liushiliu@example.com', NULL, 0, 1),
('user15', '$2a$10$zejfDzk62KylFTOrYVepr.RJm58ylp1nSReJtXMc3dVM513Qa966O', '何十七', '13800138015', 'heshiqi@example.com', NULL, 0, 1);

-- 插入分类测试数据
INSERT INTO `category` (`name`, `description`, `icon`, `sort`, `status`) VALUES
('蔬菜类', '新鲜蔬菜，绿色健康', '', 1, 1),
('水果类', '时令水果，甜美可口', '', 2, 1),
('粮食类', '优质粮食，营养健康', '', 3, 1),
('禽蛋类', '农家禽蛋，新鲜营养', '', 4, 1),
...
CREATE TABLE IF NOT EXISTS `banner` (
    ...
    `button_text` VARCHAR(50) DEFAULT '立即查看' COMMENT '按钮文案',
    `link_url` VARCHAR(255) DEFAULT '/shop' COMMENT '跳转链接',
